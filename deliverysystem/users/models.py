...
class ProductEditDetailsForm(SingletonModel):
    product_name = models.CharField(label='name')
    product_description = models.TextField(label='description')
    product_price = models.PositiveIntegerField(label='price')
    vegan = models.BooleanField(label='vegan')
    vegetarian = models.BooleanField(label='vegetarian')